            ...
            if isinstance(data, dict):
                ...
                for i, row in enumerate(data):
                    if isinstance(row, dict):
                        ...
                        if self.custom_paths == {} or (
                                parent_table_name in self.custom_paths and list_column_name in self.custom_paths[
                            parent_table_name]):
    ...
    def check_if_column_needed(self, table_path, key, value):
        try:
            ...
            if key not in self.meta_dict[table_path]['columns']:
                ...
                if self.all_paths != {} and key not in self.all_paths[
                    table_path] and table_path + "#" + key not in self.all_paths:
